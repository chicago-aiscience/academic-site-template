# Academic Site — Jupyter Book Website
...
- **User/org site** (`academic-site.github.io`): keep `BASE_URL: ''` in `.github/workflows/deploy.yml`
- **Project site** (`username.github.io/academic-site`): set `BASE_URL: '/academic-site'`
